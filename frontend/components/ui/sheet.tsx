...
const sheetVariants = cva(
	'fixed z-50 gap-4 border border-border bg-card p-6 text-card-foreground shadow-lg transition-transform duration-300 ease-out',
	{
		variants: {
			side: {
				...
				left: 'inset-y-0 left-0 h-full w-[min(100%,20rem)] border-r data-[state=closed]:-translate-x-full data-[state=open]:translate-x-0',
				right:
